...
const I18N = {
  en: {
    ...
    api: 'API',
    dispatch: 'Open',
    dispatchOpen: 'Prefill this prompt on Claude, Codex, Grok…',
    dispatchFold: 'Collapse',
    dispatchBoard: 'All',
    dispatchChat: 'Chat',
    dispatchCode: 'Code',
    dispatchPlaceholder: 'Type a prompt, then tick one or more destinations…',
    dispatchRepo: 'Repo',
    dispatchAuto: 'Auto-open',
    dispatchMulti: 'Open {n}',
    ...
    dispatchBoardHint: 'Open a card to jump to that tab. Close brings you back here.',
    ...
    dispatchHint: 'Tick destinations, then open. Ctrl+Enter auto-picks one.',
  },
  zh: {
    brand: 'TOKEN POLICE',
    legend: '数字为剩余额度',
    ...
    api: 'API',
    dispatch: '带到',
    dispatchOpen: '把提示词带到 Claude、Codex、Grok…',
    dispatchFold: '收起',
    dispatchBoard: '全部',
    dispatchChat: '对话',
    dispatchCode: '代码',
    ...
    dispatchRepo: '仓库',
    dispatchAuto: '自动带到',
    dispatchMulti: '带到 {n} 个',
    dispatchSelectReady: '全选可用',
    dispatchParallel: '同时打开',
    dispatchNeed: '先写提示词',
    dispatchEmpty: '这一类里没有额度 ≥15% 的',
    dispatchOpenedN: '已打开 {n} 个标签 · 只预填，未发送',
    dispatchBoardHint: '点卡片跳到那个标签。点「关闭」收回这一页',
    dispatchNoLive: '实时输出在对方页面。这边只留任务列表，可随时跳回去。',
    dispatchFocus: '跳到标签',
    dispatchGone: '标签已关',
    dispatchHint: '勾选入口再带到。Ctrl+Enter 自动带到最合适的一个。',
  },
};
