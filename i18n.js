...
const I18N = {
  en: {
    ...
    crosscheckNeedSource: 'Open a supported conversation in this window first.',
    crosscheckUnsupported: '{name} is open, but this page isn’t a conversation Token Police can read.',
    crosscheckUnsupportedGeneric: 'This page isn’t a conversation Token Police can read. Open ChatGPT, Claude, Grok, Cursor, Gemini, or Codex.',
    crosscheckEmpty: 'No messages on this {name} page yet — send something, then try again.',
    crosscheckEmptyGeneric: 'No messages on this page yet — send something, then try again.',
    crosscheckError: 'Could not read this tab. Reload the {name} page and keep Token Police open.',
    crosscheckErrorGeneric: 'Could not read this tab. Reload the page and keep Token Police open.',
    crosscheckReady: '{name} · {summary}',
    crosscheckSummaryMessages: '{n} messages',
    crosscheckSummaryChars: '{n} chars',
    crosscheckSummaryRepo: 'repo {name}',
    crosscheckSummaryPr: 'PR linked',
    crosscheckCapturing: 'Reading the {name} transcript…',
    crosscheckCapturingGeneric: 'Reading this tab’s transcript…',
    crosscheckPrivacy: 'Token Police does not upload this. Confirming hands the current {name} session to the reviewer you pick — into that product\'s own tab.',
    crosscheckPrivacyGeneric: 'Token Police does not upload this. Confirming hands the current session to the reviewer you pick — into that product\'s own tab.',
    ...
    crosscheckPickLabelChat: 'Chat reviewer',
    crosscheckPickLabelCode: 'Coding reviewer',
  ...
  fr: {
    ...
    crosscheckNeedSource: 'Ouvre d’abord une conversation prise en charge dans cette fenêtre.',
    crosscheckUnsupported: '{name} est ouvert, mais cette page n’est pas une conversation que Token Police peut lire.',
    crosscheckUnsupportedGeneric: 'Cette page n’est pas une conversation que Token Police peut lire. Ouvre ChatGPT, Claude, Grok, Cursor, Gemini ou Codex.',
    crosscheckEmpty: 'Pas encore de messages sur cette page {name} — envoie quelque chose, puis réessaie.',
    crosscheckEmptyGeneric: 'Pas encore de messages sur cette page — envoie quelque chose, puis réessaie.',
    crosscheckError: 'Impossible de lire cet onglet. Recharge la page {name} et garde Token Police ouvert.',
    crosscheckErrorGeneric: 'Impossible de lire cet onglet. Recharge la page et garde Token Police ouvert.',
    crosscheckReady: '{name} · {summary}',
    crosscheckSummaryMessages: '{n} messages',
    crosscheckSummaryChars: '{n} caractères',
    crosscheckSummaryRepo: 'dépôt {name}',
    crosscheckSummaryPr: 'PR liée',
    crosscheckCapturing: 'Lecture de la transcription {name}…',
    crosscheckCapturingGeneric: 'Lecture de la transcription de cet onglet…',
    crosscheckPrivacy: 'Token Police n’envoie rien sur ses serveurs. Confirmer transmet la session {name} actuelle au reviewer choisi — dans l’onglet de ce produit.',
    crosscheckPrivacyGeneric: 'Token Police n’envoie rien sur ses serveurs. Confirmer transmet la session actuelle au reviewer choisi — dans l’onglet de ce produit.',
    ...
    crosscheckPickLabel: 'Reviewer',
    crosscheckPickLabelChat: 'Reviewer chat',
    crosscheckPickLabelCode: 'Reviewer code',
    ...
    crosscheckPromptDefaultChat: 'Voici une conversation entre un autre assistant et un utilisateur. Vérifie indépendamment s’il a bien compris et répondu à la demande. Contrôle le raisonnement, les affirmations et le caractère complet de la réponse. Ne prends pas les conclusions de l’assistant précédent pour argent comptant. Signale les oublis, les erreurs et tout ce qui n’est pas encore vérifié.',
    crosscheckPromptDefaultCode: 'Voici une session complète entre un autre agent de code et un utilisateur. Vérifie indépendamment s’il a bien compris et mené à bien la demande. Contrôle les changements de code, la PR, les tests et les affirmations de fin. Ne prends pas les conclusions de l’agent précédent pour argent comptant. Signale les oublis, les erreurs, les régressions possibles et tout ce qui n’est pas encore vérifié.',
  ...
  zh: {
    ...
    crosscheckNeedSource: '先在这个窗口打开一段支持的对话。',
    crosscheckUnsupported: '当前是 {name}，但这一页还不是 Token Police 能读的对话。',
    crosscheckUnsupportedGeneric: '这一页不是 Token Police 能读的对话。请打开 ChatGPT、Claude、Grok、Cursor、Gemini 或 Codex。',
    crosscheckEmpty: '这个 {name} 页面还没有消息——先发一条再试。',
    crosscheckEmptyGeneric: '这个页面还没有消息——先发一条再试。',
    crosscheckError: '读不了这个标签。请刷新 {name} 页面，并保持 Token Police 开着。',
    crosscheckErrorGeneric: '读不了这个标签。请刷新页面，并保持 Token Police 开着。',
    crosscheckReady: '{name} · {summary}',
    crosscheckSummaryMessages: '{n} 条消息',
    crosscheckSummaryChars: '{n} 字',
    crosscheckSummaryRepo: '仓库 {name}',
    crosscheckSummaryPr: '已关联 PR',
    crosscheckCapturing: '正在读取 {name} 对话…',
    crosscheckCapturingGeneric: '正在读取这个标签的对话…',
    crosscheckPrivacy: 'Token Police 不会上传到自己的服务器。确认后，会把当前 {name} 会话交给你选的审查方——写进对方自己的标签页。',
    crosscheckPrivacyGeneric: 'Token Police 不会上传到自己的服务器。确认后，会把当前会话交给你选的审查方——写进对方自己的标签页。',
    crosscheckConfirm: '我明白——把这次会话交给我选的审查方',
    crosscheckNeedConfirm: '请先确认隐私说明',
    crosscheckNeedReviewer: '请选择审查方',
    crosscheckPickLabel: '审查方',
    crosscheckPickLabelChat: '对话审查方',
    crosscheckPickLabelCode: '编程审查方',
    ...
    crosscheckPromptDefaultChat: '下面是另一位助手与用户的对话。请独立审查它是否正确理解并回答了用户的请求。核对推理、说法和回复是否完整。不要默认前一位助手的结论是对的。指出遗漏、错误，以及任何尚未核实的部分。',
    crosscheckPromptDefaultCode: '下面是另一位编程助手与用户的完整会话。请独立审查它是否正确理解并完成了用户的请求。核对代码改动、PR、测试结果以及“已经完成”的说法。不要默认前一位助手的结论是对的。指出遗漏、错误、潜在回归，以及任何尚未核实的部分。',
